...
RUN yum install -y file ibsss_nss_idmap.x86_64 which unzip
...
# Install longranger
RUN cd opt/ && \
	curl -ko longranger-2.1.2.tar.gz "https://s3-us-west-2.amazonaws.com/10x.downloads/longranger-2.1.2.tar.gz?AWSAccessKeyId=AKIAJAZONYDS6QUPQVBA&Expires=1481016112&Signature=QBSSrD8dWE0DGDhTAqYjZcgPMCs%3D" && \
